...
exports.getProduct = (req,res) =>{
    ...
    product.find({}).limit(2).skip(req.query.page * 2).sort(sort).exec(function(err, result) {res.json(result)})
}
...
exports.updateProduct = (req,res) =>{
    ...
    product.findByIdAndUpdate({_id: req.params.product_id}).then(updateProduct => {
        if (updateProduct) {
...
exports.deleteProduct = (req,res) =>{
    product.findByIdAndRemove({_id: req.params.product_id})
